...
class APIWrapper__postTest( unittest.TestCase ):
    def setUp ( self ) -> None:
    ...
    def test_post_success_without_param ( self ):
        expected_url = "https://api.hetrixtools.com/v1//contacts/";
        expected_params = None;
        """API Instance"""
        api_wrapper = APIWrapper ( token_file_path = "dummy_file_path" );
        with patch ( "requests.post", return_value = self.expected_object_simple ) as request_post:
            returned_object = api_wrapper.post ( url = expected_url );
    ...
    def test_post_success_with_param ( self ):
        expected_url = "https://api.hetrixtools.com/v1//contacts/";
        expected_params = {
        ...
        api_wrapper = APIWrapper ( token_file_path = "dummy_file_path" );
        with patch ( "requests.post", return_value = self.expected_object_simple ) as request_post:
            returned_object = api_wrapper.post (
                url = expected_url,
                data = expected_params
            );
            request_post.assert_called_once_with (
    ...
    def test_post_connection_error ( self ):
        ...
        """API Instance"""
        api_wrapper = APIWrapper ( token_file_path = "dummy_file_path" );
        with patch ( "requests.post", side_effect = requests.ConnectionError ( "Temporary failure in name resolution" ) ) as request_post:
            returned_object = api_wrapper.post ( url = expected_url );
            request_post.assert_called_once_with (
                url = expected_url,
                data = expected_params
    ...
    def test_post_connect_timeout ( self ):
        expected_url = "https://api.hetrixtools.com/v1//contacts/";
        expected_params = None;
        """API Instance"""
        api_wrapper = APIWrapper ( token_file_path = "dummy_file_path" );
        with patch ( "requests.post", side_effect = requests.ConnectTimeout ( "Temporary failure in name resolution" ) ) as request_post:
            returned_object = api_wrapper.post ( url = expected_url );
            request_post.assert_called_once_with (
                url = expected_url,
                data = expected_params
